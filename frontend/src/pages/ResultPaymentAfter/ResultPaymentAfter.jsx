  ...
  const handlePayment = async () => {
    const config = {
      ...
      params: {
        ...
        vnp_TxnRef: vnp_TxnRef.replace(/[^\d]/g, ''),
        vnp_PayDate: vnp_PayDate
      }
    };
    const response = await axios.get(url + "/api/payment/payment-update/after", config);
      ...
      <div className="resultPaymentWrapper">
        ...
        <div className="resultPaymentDetails">
          <div className="resultPaymentDetailsTexts">
            ...
            <p className="resultPaymentDesc">Mã đơn hàng: {vnp_TxnRef.replace(/[^\d]/g, '')}</p>
...
export default ResultPaymentAfter